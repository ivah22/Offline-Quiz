    ...
    <div className="min-h-screen pb-16">
      ...
      <main className="mx-auto max-w-3xl px-5 pt-8">
        <section
          ...
          className={`group hover-glow cursor-pointer rounded-3xl border-2 border-dashed bg-card p-8 text-center shadow-card transition ${
            dragOver ? "border-primary bg-accent animate-neon-pulse" : "border-border hover:border-primary/60"
          }`}
        >
        ...
        <section className="mt-6">
          ...
          <ul className="space-y-3">
            {filtered.map((q) => {
              ...
              return (
                <li key={q.id} className="rounded-2xl border bg-card p-4 shadow-card hover-glow transition">
        ...
        <section className="mt-8 grid grid-cols-2 gap-3">
          <button onClick={backupAllQuizzes}
            className="rounded-2xl border bg-card p-4 text-left shadow-card hover-glow">
